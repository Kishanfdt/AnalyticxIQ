        ...
        <div className="flex gap-4 items-start mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-400 leading-relaxed">
              ...
              <span className="font-semibold text-white">"{customerName}"</span>? This action cannot
              be undone and will permanently remove this customer profile from your records.
            </p>
          </div>
        </div>
